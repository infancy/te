...
public:
    ...
    constexpr void_ptr(void_ptr&& other) noexcept:
        ptr{ std::move(other.ptr) }, del{ std::move(other.del) }, copy{ std::move(other.copy) }
    {
        other.ptr = nullptr;
    }
                         ...
                         Ts&&... args) noexcept
{
    ...
    return reinterpret_cast<R (*)(void*, Ts...)>(self.vptr[N - 1])(self.ptr.get(), std::forward<Ts>(args)...);
}
